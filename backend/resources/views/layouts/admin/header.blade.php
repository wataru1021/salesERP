	...
	<header class="c-header c-header-light c-header-fixed c-header-with-subheader">
		...
		<ul class="c-header-nav d-md-down-none">
			<li class="c-header-nav-item dropdown px-3">
				<a class="c-header-nav-link {{ $activeHeader == 'top' ? 'is-active' : '' }}" href="#">Top</a>
			</li>
		</ul>
		<ul class="c-header-nav d-md-down-none">
			<li class="c-header-nav-item dropdown px-3">
				<a class="c-header-nav-link dropdown-toggle {{ $activeHeader == 'reportManager' ? 'is-active' : '' }}" data-toggle="dropdown" role="button" aria-expanded="false" href="#">全営業マンの報告管理</a>
		...
		<ul class="c-header-nav d-md-down-none">
			<li class="c-header-nav-item dropdown px-3">
				<a class="c-header-nav-link {{ $activeHeader == 'user-list' ? 'is-active' : '' }}" href="{{route('admin.user.list')}}">営業マン管理</a>
			</li>
		</ul>
